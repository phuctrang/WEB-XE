<?php
			...
			if(isset($_POST["process"]))
			{
				...
				move_uploaded_file($tmp_name,$path.$anh);
					$sql = "insert into thongtinxe(maxe,anh,tenxe,noisx,ngaysx) values('$maxe','$hinhanh','$tenxe','$noisanxuat','$ngaysanxuat')";
...
<div>
	...
	<div style="text-align: center; color: red;">
					<marquee direction="down" style="text-align: center; color: red;" ><h1><i>ツThêm✿thông✿էin࿐</i></h1></marquee>
					
	</div>
	<form action="" method="post"  enctype="multipart/form-data" style="margin-left: 400px;margin-top : 50px; "  align="left" >

		<table width="500"  border="1" style="margin: 10px; padding-top: 20px;text-align: top;">
			
			<tr>
				<td>Mã xe: </td>
				<td><input type="text" name="maxe" ></td>
			</tr>
			<tr>
				<td>ảnh: </td>
			...
			<tr>
				<td>Nơi sản xuất: </td>
				<td><input type="text" name="noisx" ></td>
			</tr>
			<tr>
				<td>Ngày sản xuất: </td>
				<td><input type="date" name="ngaysx" ></td>
			</tr>

				<tr>
				<td></td>
				<td><input type="submit" name="process" value="Xác nhận thêm" ></td>
			</tr>
		</table>
	</form> 
</div>
