...
<body style="border-color:  #8989b7;">
	<div class="infor" style="border-color: #8989b7;">
				<meta charset="utf-8">
				<div style="color: blue;"><i><a href="index.php">	&larr;Quay về trang chủ</a></i></div>
				<div style="text-align: center; color: red;">
					<marquee direction="down" style="text-align: center; color: red;" ><h1><i>* Giỏ hàng của bạn *</i></h1></marquee>
				...
				; border-color: orange; color: black; " >
					...
					<tr>
						...
						<th width="100px;"><a href="index.php" style="color:  black;">	&rarr;Thêm</a></th>
					</tr>
			<?php while ($row = mysqli_fetch_array($result)){
			 ...
			 ?>
					<tr>
						...
						<td>
							<a onclick="return window.confirm('Bạn muốn xóa không');" href="xoagiohang.php?quanly=xoagiohang&id=<?php echo $row['id']; ?>"style="color:  black;">	&rarr;Xóa</a>
						</td>
					</tr>
			 <?php } ?>
